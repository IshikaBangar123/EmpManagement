...
public class EmployeeServiceImpl implements EmployeeService{
    ...
    public CommonResponse saveEmp(EmployeeDto dto){
        try{
            ...
            emp.setDateOfJoining(stringToDateFormat(String.valueOf(dto.getDateOfJoining()), "dd-MM-yyyy"));
            emp.setDateOfBirth(stringToDateFormat(String.valueOf(dto.getDateOfBirth()), "dd-MM-yyyy"));
            emp.setDesignation(Designation.valueOf(String.valueOf(dto.getDesignation())));
